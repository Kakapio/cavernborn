...
/// Convert chunk coordinates to world-space coordinates.
pub fn chunk_to_world(chunk_pos: UVec2) -> UVec2 {
    UVec2::new(chunk_pos.x * CHUNK_SIZE, chunk_pos.y * CHUNK_SIZE)
}
