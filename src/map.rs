...
impl Map {
    ...
    fn roll_special_particle(depth: u32, rng: &mut ThreadRng) -> Option<Particle> {
    ...
    fn calculate_surface_heights(&self, map_width: u32, map_height: u32) -> Vec<u32> {
    ...
    fn create_empty_chunks(&self, chunks_width: u32, chunks_height: u32) -> Vec<Chunk> {
    ...
    fn generate_all_data(&self, map_width: u32, map_height: u32) -> Vec<Chunk> {
        ...
        let surface_heights = self.calculate_surface_heights(map_width, map_height);
        ...
        // Create empty chunks
        let chunks = self.create_empty_chunks(chunks_width, chunks_height);
